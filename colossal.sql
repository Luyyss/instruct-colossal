...
-- Started on 2020-07-05 14:45:19
...
--
-- TOC entry 2828 (class 0 OID 16394)
-- Dependencies: 202
-- Data for Name: tb_cidade; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tb_cidade (codigo_ibge, nome) FROM stdin;
...
COPY public.tb_estado (prefixo, sigla) FROM stdin;
12	AC
27	AL
16	AP
13	AM
...
--
-- TOC entry 2829 (class 0 OID 16400)
-- Dependencies: 203
-- Data for Name: tb_feriado; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.tb_feriado (name, poder, ano, mes, dia, tipo, local, id_feriado) FROM stdin;
Ano novo	N	\N	01	01	F	\N	32
Tiradentes	N	\N	04	21	F	\N	33
Dia do Trabalhador	N	\N	05	01	F	\N	34
Independência	N	\N	09	07	F	\N	35
Nossa Senhora Aparecida	N	\N	10	12	F	\N	36
Finados	N	\N	11	02	F	\N	37
Proclamação da República	N	\N	11	15	F	\N	38
Natal	N	\N	12	25	F	\N	39
\.
...
-- Dependencies: 205
-- Name: tb_feriado_id_feriado_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.tb_feriado_id_feriado_seq', 39, true);


-- Completed on 2020-07-05 14:45:19
